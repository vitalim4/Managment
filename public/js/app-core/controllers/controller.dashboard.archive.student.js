angular.module("FPM").controller('dashboardArchiveAllStudentProjectsController', function ($scope, $window, $http, localStorageService, DTColumnBuilder, DTOptionsBuilder, globalSettings,Projects, $timeout) {
